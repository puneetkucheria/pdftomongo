...
def convert_from_path(pdf_path, dpi=200, output_folder='images', first_page=1, last_page=100, fmt='jpg', thread_count=1, userpw=None):
    """
...
if __name__ == '__main__':
    print(convert_from_path('RetailPharmacyInventory.pdf'))
